...
tools: Task, Bash, Glob, Grep, LS, ExitPlanMode, Read, NotebookRead, WebFetch, TodoWrite, WebSearch, mcp__miru__fetch_library_docs, ListMcpResourcesTool, ReadMcpResourceTool, mcp__grep__searchGitHub, mcp__context7__resolve-library-id, mcp__context7__get-library-docs
---
